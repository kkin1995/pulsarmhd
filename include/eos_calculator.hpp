 ...
 * ./eos_calculator MAGNETIC_BPS --nB-min 1e22 --nB-max 1e37 --num-points 500 --output
 * custom_eos.csv --B-ratio 0.01
 *
...
struct EOSParameters {
   ...
   */
  EOSParameters()
      : nB_min(1e22), nB_max(1e37), num_points(250), output_file("eos_output.csv"),
        atomic_mass_file("data/atomic_masses.csv"), B_ratio_electron(0.01), rel_tolerance(1e-6),
        abs_tolerance(1e-8), debug_mode(false), rho_min(1e6), rho_max(1e15), mu_e(2.0) {}
};
