 ...
 * considers three particle species (neutrons, protons, and electrons) and their quantum statistical 
 * behavior in different density regimes.
 */
 ...
 * protons, and electrons under beta equilibrium conditions. It handles three distinct density regimes:
...
class NonMagneticNPEGas {
    private:
         ...
         * @private
         * 
         * @details This private nested class implements a numerical solver for beta equilibrium conditions
         * in dense nuclear matter. Beta equilibrium represents the balance between the 
