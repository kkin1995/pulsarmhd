...
outfile = "data/sahu_basu_datta_bbp_magnetic_bps_b_1e-04.csv"

magnetic_bps_eos = pd.read_csv(
    "/home/karan-kinariwala/Dropbox/KARAN/2-Areas/Education/PhD/3-Research/pulsarmhd/data/bps_single_b_b_1e-04.csv",
    header=0
)
